...
def setup_task(args, **kwargs):
    print("setup_task in __init__.py, args: ", args) # used by unimol_finetune.py and unimol's infer.py
    return TASK_REGISTRY[args.task].setup_task(args, **kwargs) # execute the specific task's setup_task fn
...
for file in os.listdir(tasks_dir):
    ...
    if (
        ...
        module = importlib.import_module("unimol.core.tasks." + task_name)

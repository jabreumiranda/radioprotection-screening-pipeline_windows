...
def build_model(args, task):
    print("unicore models>__init__.py's build_model ARCH_MODEL_REGISTRY: ", ARCH_MODEL_REGISTRY)
    return ARCH_MODEL_REGISTRY[args.arch].build_model(args, task) # args.arch comes from --arch
...
for file in os.listdir(models_dir):
    ...
    if not file.startswith("_") and not file.startswith(".") and (file.endswith(".py") or os.path.isdir(path)):
        ...
        module = importlib.import_module("unimol.core.models." + model_name)

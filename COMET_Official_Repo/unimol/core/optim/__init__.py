...
from unimol.core.optim.unicore_optimizer import (  # noqa
    UnicoreOptimizer,
)
from unimol.core.optim.fp16_optimizer import FP16Optimizer
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith(".py") and not file.startswith("_"):
        ...
        importlib.import_module("unimol.core.optim." + file_name)

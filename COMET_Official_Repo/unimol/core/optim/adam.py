...
import torch
import torch.optim
from unimol.core.optim import UnicoreOptimizer, register_optimizer
from unimol.core.optim.fused_adam import get_fused_adam_class


logger = logging.getLogger(__name__)


# print("@register_optimizer(adam)")

...
# TODO NOW: Edit this to dynamically change dataset sources (e.g. dropping datasets that are overfitted by model) - possibly make a new class to handle this        
class EpochBatchIterator(EpochBatchIterating):
    ...
    def _get_iterator_for_epoch(
        ...
        # TODO NOW: Edit this to dynamically change dataset sources (e.g. dropping datasets that are overfitted by model)
        # Create data loader
        # print("_get_iterator_for_epoch, self.dataset: ", self.dataset)

...
class SelfMultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        # print("selfmultiheadattn query.size(): ", query.size())
        ...
        # print("selfmultiheadattn q.size() A: ", q.size())
        if k is not None:
            k = (
        ...
        # print("selfmultiheadattn q.size() B: ", q.size())
        # print("selfmultiheadattn k.transpose(1, 2).size(): ", k.transpose(1, 2).size())
        attn_weights = torch.bmm(q, k.transpose(1, 2))
        # print("selfmultiheadattn attn_weights.shape A: ", attn_weights.shape) # [bsz * self.num_heads, tgt_len, src_len]
        ...
        # print("selfmultiheadattn attn_weights.shape B: ", attn_weights.shape)
        if not return_attn:
        ...
        # print("selfmultiheadattn attn.shape: ", attn.shape)

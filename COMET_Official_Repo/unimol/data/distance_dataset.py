...
class EdgeTypeDataset(BaseWrapperDataset):
    ...
    def __getitem__(self, index: int):
        ...
        # print("EdgeTypeDataset node_input: ", node_input)
        # print("EdgeTypeDataset self.num_types: ", self.num_types)
        # print("EdgeTypeDataset node_input.view(-1, 1) * self.num_types: ", node_input.view(-1, 1) * self.num_types)

        offset = node_input.view(-1, 1) * self.num_types + node_input.view(1, -1)
        # set offset as the index number for each unique atom-atom pair, to encode edges.

        # print("EdgeTypeDataset offset: ", offset)

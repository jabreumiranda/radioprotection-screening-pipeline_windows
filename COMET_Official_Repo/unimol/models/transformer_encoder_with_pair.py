...
class TransformerEncoderWithPair(nn.Module):
    ...
    def forward(
        ...
        delta_pair_repr = attn_mask - input_attn_mask # to remove the initial attn_bias at the input layer which encodes the 3D distances
        ...
        # attn_mask == encoder_pair_rep -> encoder_distance = self.dist_head(encoder_pair_rep)

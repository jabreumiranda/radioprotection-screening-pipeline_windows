...
root_task_name='processed_data_dirs/demo_SSLNP/in_house_sslnp_data_overall_lance_without_pbae+p1_lyo_sucrose_2024-03-13_npratios_foldsslabel_20fixedtestLNPs_LANCELNPtrain100pct_fold_V0'  # data folder name
...
full_dataset_task_schema_path = "task_schemas/in_house_lnp_master_schema_NPratio_AOvolratio_PBAE_SSLNP.json"
                                                                        ...
                                                                        for percent_noise_type in percent_noise_types:
                                                                            for patience in patiences:
                                                                                for train_data_ratio in train_data_ratios:
                                                                                    ...
                                                                                    eval_results_path = os.path.join("./infer_results_sslnp/", results_folder) # eval_results_path='./infer_demo_in_house_lnp_debug_09142023_contrastive_lr0.0004_bs16_epoch200_npratio_debug_finetuneafterpretraining'
                                                                                    ...
                                                                                    # !rm -rf save_demo_pdna_lnp_mse
                                                                                    # subprocess.run(f"rm -rf {save_dir}")

...
root_task_name='processed_data_dirs/demo_CACO2/in_house_lnp_data_overall_lance_without_pbae+caco2_2024-04-16_npratios_foldcaco2label_fig2a/fold_V0'  # data folder name
...
full_dataset_task_schema_path = "task_schemas/in_house_lnp_master_schema_NPratio_AOvolratio_PBAE_CACO2.json"
patiences = [20] # train until end of epoch
subdataset_patiences = [-1]
epoch_to_freeze_molecule_encoder_list = [1000000]
cagrad_cs = [0, 0.1]
percent_noises = [0, 0.1]
contrast_margin_coeffs = [0, 0.01]
percent_noise_types = ['normal_proportionate']
save_all_model_weights = False
train_data_ratios = [1]
                                                                        ...
                                                                        for percent_noise_type in percent_noise_types:
                                                                            for patience in patiences:
                                                                                for train_data_ratio in train_data_ratios:
                                                                                    ...
                                                                                    exp_name=f'demo_in_house_ED16042024_LNPfoldcaco2_fold_V0_lnp_{loss_func}-bs{batch_size}-lr{lr}-lnpmodparams{lnp_encoder_layers}-{lnp_encoder_embed_dim}-{lnp_encoder_ffn_embed_dim}-{lnp_encoder_attention_heads}-trainrat{train_data_ratio}-ep{max_epoch}-pat{patience}-metric{metric}-cagrad{cagrad_c}-percentnoise{percent_noise}-labelmargin{contrast_margin_coeff}-seed{seed}_OS'  
                                                                                    ...
                                                                                    eval_results_path = os.path.join("./infer_results_caco2/", results_folder) 
